...
class MenuSection extends Component {
  ...
  renderFailureView = () => (
    <div className="restaurant-error-view-container">
      <img
        src="https://res.cloudinary.com/dc4qrvfpr/image/upload/v1680251359/restaurantFailure_plxiu5.jpg"
      ...
      <div>
        ...
        <div className="all-restaurant-responsive-container">
          ...
          <div className="restaurant-navigation">
            ...
            >
              <img
                src="https://res.cloudinary.com/dc4qrvfpr/image/upload/v1680251576/tastyIcon_djidt6.jpg"
                alt=""
                className="arrow"
              />
            </button>
